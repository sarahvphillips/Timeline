...
- [ ] **Credits shop catalogue (later):** only add items after weighing (1) build cost, (2) how often it would actually be used, (3) how much people want it vs a free tool. Current placeholders can stay or be replaced. Do not price everyday logging (poems, events, word-to-int). Prefer perks like delivery clips, Open Banking, extra invite room, video trim/checksum packs.
